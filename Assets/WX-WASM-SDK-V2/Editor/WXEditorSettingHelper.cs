    ...
    public class WXSettingsHelper
    {
        ...
        private void ApplyPerfAnalysisSetting()
        {
            ...
            if (shouldAddSymbol)
            {
                ...
                {
                    PlayerSettings.SetScriptingDefineSymbols(NamedBuildTarget.FromBuildTargetGroup(EditorUserBuildSettings.selectedBuildTargetGroup), MACRO_ENABLE_WX_PERF_FEATURE + $";{defineSymbols}");
                }
            }
            else
            {
